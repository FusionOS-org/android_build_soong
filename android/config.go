...
func (c *config) JavaSourceOverlays() string {
	return String(c.productVariables.Fuse.Java_Source_Overlays)
}

func (c *config) JavaSourceOverlayModuleWhitelist() []string {
	return android.FuseConfig.JavaSourceOverlayModuleWhitelist
}
...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.productVariables.Fuse.Specific_camera_parameter_library)
}
